import type { EnabledOAuthProvider } from '../../services/authMode';
import { useLanguage } from '../../contexts/useLanguage';

interface OAuthButtonsProps {
  providers: EnabledOAuthProvider[];
  disabled: boolean;
  onSelect: (provider: EnabledOAuthProvider) => void;
}
...
export const OAuthButtons = ({ providers, disabled, onSelect }: OAuthButtonsProps) => {
  const { t } = useLanguage();
